...
class _PlicImpl:
    ...
    def __init__(self, dut, clk, plic_base):
        ...
        self.dut.plic_we.value = Immediate(0)
        self.dut.plic_re.value = Immediate(0)
        self.dut.plic_be.value = Immediate(0)
        self.dut.plic_waddr.value = Immediate(0)
        self.dut.plic_raddr.value = Immediate(0)
        self.dut.plic_wdata.value = Immediate(0)
        ...
        self.dut.ext_irq_src_i.value = Immediate(0)
